...
public class ContaBancaria {
	 ...
	 public void abrirConta() throws SQLException {
          ...
          try (Scanner tipoForm = new Scanner(System.in)) {
...
//dados de ingresso para abertura de conta
      ...
      try (Scanner inputName = new Scanner(System.in)) {
			...
			nome_conta = inputName.nextLine().toUpperCase();
			
      
      try (Scanner inputCpf = new Scanner(System.in)) {
			System.out.println("Digite o CPF: ");
			cpf_conta = inputCpf.nextLine();
			
		
      
      System.out.printf("Nome: ", nome_conta);
      System.out.printf("CPF: ", cpf_conta);
  ...
  // inserir os dados no banco de dados
      try (Connection connection = ConnectionDB.getConexaoSQLServer()) {
          ...
          System.out.println("Ocorreu um erro ao conectar ao banco de dados: " + e.getMessage());
  	  	...
  	  	System.out.println("Erro: " + e.getMessage());
  	    System.out.println("Ocorreu um erro durante a leitura dos dados CPF.");
  	    //return;
  	    }
	  }	
          
          
	 }/*Fechando Class abrirConta*/
   ...
   public void operarConta() {
        ...
        if (verificarContaExiste(numeroDigitado)) {
            ...
            do {
                ...
                try (Scanner digiteOperar = new Scanner(System.in)) {
...
void efetuarDeposito(int numeroDigitado) {
    try (Scanner inputValorDeposito = new Scanner(System.in)) {
...
void efetuarTransferencia() {
    try (Scanner inputContaOrigem = new Scanner(System.in)) {
		System.out.println("Digite o número da conta de origem: ");
		int numeroContaOrigem = inputContaOrigem.nextInt();

		try (Scanner inputContaDestino = new Scanner(System.in)) {
			System.out.println("Digite o número da conta de destino: ");
			int numeroContaDestino = inputContaDestino.nextInt();

			try (Scanner inputValorTransferencia = new Scanner(System.in)) {
...
void efetuarSaque(int numeroDigitado) {
    try (Scanner inputValorSaque = new Scanner(System.in)) {
...
void encerrarConta() {
    try (Scanner inputNumeroConta = new Scanner(System.in)) {
